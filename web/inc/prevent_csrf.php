...
function checkStrictness($level) {
	if ($level >= $_SESSION["POLICY_CSRF_STRICTNESS"]) {
		...
		$csrf_msg =
			"<h1>Potential CSRF use detected</h1>\n" .
			"<p>Please disable any plugins/add-ons inside your browser or contact your system administrator. " .
			"If you are the system administrator you can run " .
			"v-change-sys-config-value 'POLICY_CSRF_STRICTNESS' '0' as root " .
			"to disable this check.<p>" .
