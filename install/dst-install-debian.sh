...
if [ "$type" = "ubuntu" ]; then
	check_result 1 "You are running the wrong installer for Ubuntu. Please run dst-install.sh or dst-install-ubuntu.sh instead."
...
conflicts_pkg="exim4 mariadb-server apache2 nginx devcp postfix"
