...
<div class="container">
    ...
    >
        ...
        <div class="form-container">
            ...
            <div class="u-mb10 js-stats-auth" style="<?php if ($v_stats == "none") {
                ?>display:none<?php
                                                     } ?>">
                    ...
                    <?php if (!empty($_SESSION["PROXY_SYSTEM"])) { ?>
                        ...
                        <div x-cloak x-show="proxySupportEnabled" id="proxytable">
                            ...
                            <div class="u-mb10">
                                ...
                                <?php
                                $default_proxy_ext = 'jpg, jpeg, gif, png, ico, svg, css, zip, tgz, gz, rar, bz2, exe, pdf, doc, xls, ppt, txt, odt, ods, odp, odf, tar, bmp, rtf, js, mp3, avi, mpeg, flv, html, htm';
                                ?>
                                <textarea class="form-control u-min-height100" name="v_proxy_ext" id="v_proxy_ext"><?= htmlentities(!empty($v_proxy_ext) ? trim($v_proxy_ext, "'") : $default_proxy_ext) ?></textarea>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
