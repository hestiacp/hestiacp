...
$subdomain_grouping_enabled = is_subdomain_grouping_enabled();
...
if (!empty($_POST["ok"])) {
	...
	if ($subdomain_grouping_enabled && !empty($_POST["v_parent_domain"])) {
...
$accept = $_GET["accept"] ?? "";
$add_mode =
	$subdomain_grouping_enabled && ($_POST["type"] ?? ($_GET["type"] ?? "")) === "subdomain"
		? "subdomain"
		: "domain";
