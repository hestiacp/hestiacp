    ...
    <div class="toolbar-inner">
        <div class="toolbar-buttons">
            <?php if ($read_only !== "true") { ?>
                <?php $create_snapshot_href = "/schedule/backup/incremental/?token=" . $_SESSION["token"]; ?>
                <a href="<?= $create_snapshot_href ?>" class="button button-secondary js-button-create">
        ...
        <div class="toolbar-right">
            <?php if ($read_only !== "true") { ?>
                <form x-data x-bind="BulkEdit" action="/bulk/backup/incremental/" method="post">
                    ...
                    <button
                        type="submit"
                        class="toolbar-input-submit"
                        title="<?= _("Apply to selected") ?>">
                    ...
                    <?php if (!$read_only) { ?>
                        <ul class="units-table-row-actions">
                            <li class="units-table-row-action shortcut-enter" data-key-action="href">
                                <?php
                                $browse_href = "/list/backup/incremental/?snapshot="
                                    . $value['short_id']
                                    . "&browse=yes&token="
                                    . $_SESSION["token"];
                                ?>
                                <a href="<?= $browse_href ?>" title="<?= _("Browse") ?>">
                                    <i class="fas fa-folder-open icon-lightblue icon-dim"></i>
                                </a>
                            </li>
                            <li class="units-table-row-action shortcut-enter" data-key-action="href">
                                <?php
                                $action_restore = "/list/backup/incremental/?snapshot="
                                    . $value['short_id']
                                    . "&token="
                                    . $_SESSION["token"];
                                ?>
                                <a href="<?= $action_restore ?>" title="<?= _("Restore") ?>">
