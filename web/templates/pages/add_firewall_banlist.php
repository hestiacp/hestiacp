        ...
        <div class="form-container">
            ...
            <div class="u-mb10">
                ...
                <select class="form-select" name="v_chain" id="v_chain">
                    <option value="SSH" <?php if ((!empty($v_chain)) && ( $v_chain == "'SSH'" )) {
                        echo 'selected';
                                        }?>><?= _("SSH") ?></option>
                    <option value="WEB" <?php if ((!empty($v_chain)) && ( $v_chain == "'WEB'" )) {
                        echo 'selected';
                                        }?>><?= _("WEB") ?></option>
                    <option value="FTP" <?php if ((!empty($v_chain)) && ( $v_chain == "'FTP'" )) {
                        echo 'selected';
                                        }?>><?= _("FTP") ?></option>
                    <option value="DNS" <?php if ((!empty($v_chain)) && ( $v_chain == "'DNS'" )) {
                        echo 'selected';
                                        }?>><?= _("DNS") ?></option>
                    <option value="MAIL" <?php if ((!empty($v_chain)) && ( $v_chain == "'MAIL'" )) {
                        echo 'selected';
                                         }?>><?= _("MAIL") ?></option>
                    <option value="DB" <?php if ((!empty($v_chain)) && ( $v_chain == "'DB'" )) {
                        echo 'selected';
                                       }?>><?= _("DB") ?></option>
                    <option value="HESTIA" <?php if ((!empty($v_chain)) && ( $v_chain == "'HESTIA'" )) {
                        echo 'selected';
                                           }?>><?= _("HESTIA") ?></option>
                </select>
            </div>
