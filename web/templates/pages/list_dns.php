            ...
            <div class="toolbar-sorting">
                ...
                <ul class="toolbar-sorting-menu js-sorting-menu u-hidden">
                    ...
                    <li data-entity="sort-expire" data-sort-as-int="1">
                        <span class="name">
                            <?= _("Expire") ?> <i class="fas fa-arrow-down-a-z"></i>
                        </span>
                        <span class="up"><i class="fas fa-arrow-up-a-z"></i></span>
                    </li>
                    <li data-entity="sort-ip">
                        <span class="name">
                            <?= _("IP Address") ?> <i class="fas fa-arrow-down-a-z"></i>
                        </span>
                        <span class="up"><i class="fas fa-arrow-up-a-z"></i></span>
                    </li>
                    ...
                    <li data-entity="sort-records">
                        <span class="name">
                            <?= _("Records") ?> <i class="fas fa-arrow-down-a-z"></i>
                        </span>
                        <span class="up"><i class="fas fa-arrow-up-a-z"></i></span>
                    </li>
                </ul>
        ...
        foreach ($data as $key => $value) {
            ...
            <div class="units-table-row <?php if ($status == 'suspended') {
                ...
                <div class="units-table-cell units-table-heading-cell u-text-bold">
                    ...
                    <a
                        href="/list/dns/?domain=<?= $domain_html ?>&token=<?= $session_token ?>"
                        title="<?= _("DNS Records") ?>: <?= $domain_html ?>">
                        <?= htmlentities($key) ?>
                    </a>
                    <?= $src_html ?>
                </div>
                            ...
                            <?php if ($data[$key]["SUSPENDED"] == "no") { ?>
                                <li class="units-table-row-action shortcut-n" data-key-action="href">
                                    <a
                                        ...
                                        href="/add/dns/?domain=<?= $domain_html ?>&token=<?= $session_token ?>"
                                ...
                                <li class="units-table-row-action shortcut-enter" data-key-action="href">
                                    <a
                                        class="units-table-row-action-link"
                                        href="/edit/dns/?domain=<?= $domain_html ?>&token=<?= $session_token ?>"
