...
ID='16' RECORD='@' TYPE='SSHFP' PRIORITY='' VALUE='%sshfp1%' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='17' RECORD='@' TYPE='SSHFP' PRIORITY='' VALUE='%sshfp2%' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='18' RECORD='@' TYPE='SSHFP' PRIORITY='' VALUE='%sshfp3%' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='19' RECORD='@' TYPE='SSHFP' PRIORITY='' VALUE='%sshfp4%' SUSPENDED='no' TIME='%time%' DATE='%date%'
