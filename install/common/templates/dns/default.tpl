...
ID='18' RECORD='_imap._tcp' TYPE='SRV' PRIORITY='1 0' VALUE='143 mail.%domain%.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='19' RECORD='_imaps._tcp' TYPE='SRV' PRIORITY='1 0' VALUE='993 mail.%domain%.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='20' RECORD='_pop3._tcp' TYPE='SRV' PRIORITY='1 0' VALUE='110 mail.%domain%.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='21' RECORD='_pop3s._tcp' TYPE='SRV' PRIORITY='1 0' VALUE='995 mail.%domain%.' SUSPENDED='no' TIME='%time%' DATE='%date%'
