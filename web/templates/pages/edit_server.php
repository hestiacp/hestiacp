                    ...
                    <div class="box-collapse-content">
                        ...
                        <?php if ($v_pgsql == "yes") { ?>
                            ...
                            <div class="u-mb20">
                                ...
                                <?php $db_pga_alias_html = htmlentities($_SESSION["DB_PGA_ALIAS"]); ?>
                                <input
                                    type="text"
                                    class="form-control"
                                    name="v_pgsql_url"
                                    id="v_pgsql_url"
                                    value="<?= $db_pga_alias_html ?>">
                            </div>
                        <?php } ?>
                        <?php if ($v_pgsql == "yes") {
                            $i = 0;
            ...
            <div class="box-collapse-content">
                ...
                <div class="u-mb10">
                    <label for="v_backup_mode" class="form-label">
                        <?= _("Compression") ?>
                        <?php
                        $backup_docs_url = 'https://hestiacp.com/docs/server-administration/backup-restore.html'
                            . '#what-is-the-difference-between-zstd-and-gzip';
                        ?>
                        <a
                            href="<?= $backup_docs_url ?>"
                            target="_blank"
                            class="u-ml5">
