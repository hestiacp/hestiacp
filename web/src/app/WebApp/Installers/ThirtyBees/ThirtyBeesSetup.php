...
class ThirtyBeesSetup extends BaseSetup {
    ...
    protected $config = [
        ...
        "resources" => [
            "archive" => [
                "src" => "https://github.com/thirtybees/thirtybees/releases/download/1.5.1/thirtybees-v1.5.1-php7.4.zip",
            ],
        ],
        "server" => [
            "nginx" => [
    ...
    if (is_dir($installDir)) {
        ...
        error_log("No se pudo encontrar el directorio de instalación para eliminar: " . $installDir);
    }
