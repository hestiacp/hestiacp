    ...
    <div class="toolbar-inner">
        <div class="toolbar-buttons">
            <?php if ($read_only !== "true") { ?>
                <?php $create_backup_href = "/schedule/backup/?token=" . $_SESSION["token"]; ?>
                <a href="<?= $create_backup_href ?>" class="button button-secondary">
                    <i class="fas fa-circle-plus icon-green"></i><?= _("Create Backup") ?>
                </a>
                <?php $backup_exclusions_href = "/list/backup/exclusions/"; ?>
                <a href="<?= $backup_exclusions_href ?>" class="button button-secondary">
                    <i class="fas fa-folder-minus icon-orange"></i><?= _("Backup Exclusions") ?>
                </a>
            <?php } ?>
            <?php if ($panel[$user_plain]['BACKUPS_INCREMENTAL'] === 'yes') { ?>
                <?php $incremental_href = "/list/backup/incremental/"; ?>
                <a href="<?= $incremental_href ?>" class="button button-secondary">
                    <i class="fas fa-vault icon-blue"></i><?= _("Incremental Backups") ?>
                </a>
            <?php } ?>
        </div>
