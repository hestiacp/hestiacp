...
if (
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/DevIT/web/inc/mail-wrapper.php" ||
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/DevIT//web/inc/mail-wrapper.php"
) {
	$check_csrf = false;
...
if (
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/DevIT/web/api/index.php" ||
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/DevIT/web//api/index.php"
) {
	$check_csrf = false;
} // Own check
if (substr($_SERVER["SCRIPT_FILENAME"], 0, 22) == "/usr/local/DevIT/bin/") {
	$check_csrf = false;
}
