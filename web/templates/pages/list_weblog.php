                        ...
                        <nav x-data="{ open: false }" class="top-bar-menu">
                            ...
                            <div x-cloak x-show="open" x-on:click.outside="open = false" class="top-bar-menu-panel">
                                <ul class="top-bar-menu-list">
                                    ...
                                    <li class="top-bar-menu-item">
                                        <a class="top-bar-menu-link <?php if ($_GET['type'] == 'access') {
                                            echo 'active';
                                                                    } ?>" href="/list/web-log/?domain=<?= htmlentities($_GET['domain']) ?>&type=access&token=<?= $_SESSION['token'] ?>" title="<?= _("View Logs") ?>">
                                    ...
                                    <li class="top-bar-menu-item">
                                        <a class="top-bar-menu-link <?php if ($_GET['type'] == 'access') {
                                            echo 'active';
                                                                    } ?>" href="/download/web-log/?domain=<?= htmlentities($_GET['domain']) ?>&type=access&&token=<?= $_SESSION['token'] ?>" title="<?= _("Download") ?>">
                                            <i class="fas fa-download"></i>
                                            <span class="u-hidden"><?= _("Download") ?></span>
                                        </a>
                                    </li>
                                    <li class="top-bar-menu-item">
                                        <a class="top-bar-menu-link <?php if ($_GET['type'] == 'error') {
                                            echo 'active';
                                                                    } ?>" href="/list/web-log/?domain=<?= htmlentities($_GET['domain']) ?>&type=error&token=<?= $_SESSION['token'] ?>" title="<?= _("Error Log") ?>">
                                    ...
                                    <li class="top-bar-menu-item">
                                        <a class="top-bar-menu-link <?php if ($_GET['type'] == 'error') {
                                            echo 'active';
                                                                    } ?>" href="/download/web-log/?domain=<?= htmlentities($_GET['domain']) ?>&type=error&token=<?= $_SESSION['token'] ?>" title="<?= _("Download") ?>">
                                            <i class="fas fa-download"></i>
                                            <span class="u-hidden"><?= _("Download") ?></span>
                                        </a>
                                    </li>
