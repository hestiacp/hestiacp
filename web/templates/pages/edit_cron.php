    ...
    <form id="main-form" name="v_edit_cron" method="post" class="<?= $v_status ?>">
        ...
        <div class="form-container form-container-wide">
            ...
            <div class="u-mb20">
                ...
                <?php $v_cmd_value = htmlentities(trim($v_cmd, "'")); ?>
                <input
                    type="text"
                    class="form-control"
                    name="v_cmd"
            ...
            <div class="sidebar-left-grid">
                <div class="sidebar-left-grid-sidebar">
                    <div class="u-mb10">
                        ...
                        <?php $v_min_value = htmlentities(trim($v_min, "'")); ?>
                        <input
                            type="text"
                            class="form-control"
                            name="v_min"
                    ...
                    <div class="u-mb10">
                        ...
                        <?php $v_hour_value = htmlentities(trim($v_hour, "'")); ?>
                        <input
                            type="text"
                            class="form-control"
                            name="v_hour"
                    ...
                    <div class="u-mb10">
                        ...
                        <?php $v_day_value = htmlentities(trim($v_day, "'")); ?>
                        <input
                            type="text"
                            class="form-control"
                            name="v_day"
                    ...
                    <div class="u-mb10">
                        ...
                        <?php $v_month_value = htmlentities(trim($v_month, "'")); ?>
                        <input
                            type="text"
                            class="form-control"
                            name="v_month"
                    ...
                    <div class="u-mb10">
                        ...
                        <?php $v_wday_value = htmlentities(trim($v_wday, "'")); ?>
                        <input
                            type="text"
                            class="form-control"
                            name="v_wday"
