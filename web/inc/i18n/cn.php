...
$LANG['cn'] = array(
    ...
    'CIDR format is supported' => '支持CIDR格式，防火墙规则支持选择IP列表',
    'ACCEPT' => '放行',
    'DROP' => '阻止',
    'TCP' => 'TCP',
    'UDP' => 'UDP',
    ...
    'Adding Firewall Ipset List' => '添加IP列表以用于防火墙规则',
    'Ip List Name' => 'IP列表名称',
    'Data Source' => '数据来源',
    'Ip Version' => 'IP版本',
    'Autoupdate' => '自动更新',
    ...
    '1 Ipset list' => '1 个IP列表',
    '%s Ipset lists' => '%s 个IP列表',
    'There are currently no IP lists defined.' => '目前没有定义IP列表',
    'list ipset' => 'IPset IP列表',
