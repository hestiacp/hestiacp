...
<div class="toolbar">
    <div class="toolbar-inner">
        <div class="toolbar-buttons">
            ...
            <?php
            $restore_all_href = "/schedule/restore/?token="
                . $_SESSION["token"]
                . "&backup="
                . htmlentities($_GET["backup"]);
            ?>
                    ...
                    <div class="units-table-cell">
                        <ul class="units-table-row-actions">
                            <li class="units-table-row-action shortcut-enter" data-key-action="href">
                                <?php
                                $restore_href = "/schedule/restore/?backup="
                                    . $backup
                                    . "&type=web&object="
                                    . $key
                                    . "&token="
                                    . $_SESSION["token"];
                                ?>
                                <?php $restore_confirm = sprintf(_("Are you sure you want to restore %s?"), $key); ?>
                                <a
                                    class="units-table-row-action-link data-controls js-confirm-action"
                                    href="<?= $restore_href ?>"
                                    title="<?= _("Restore") ?>"
                                    data-confirm-title="<?= _("Restore") ?>"
                                    data-confirm-message="<?= $restore_confirm ?>">
                    ...
                    <div class="units-table-cell">
                        <ul class="units-table-row-actions">
                            <li class="units-table-row-action shortcut-enter" data-key-action="href">
                                ...
                                $restore_href = "/schedule/restore/?backup="
                                    . $backup
                                    . "&type=cron&object=records&token="
                                    . $_SESSION["token"];
                                ?>
                                <?php $restore_confirm = sprintf(_("Are you sure you want to restore %s?"), $key); ?>
                                <a
