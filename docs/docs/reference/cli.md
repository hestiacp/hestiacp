...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-acknowledge-user-notification)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-access-key)
...
This function creates a key file in $DevIT/data/access-keys/

## v-add-backup-host

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-backup-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-backup-host-restic)
...
## v-add-cron-DevIT-autoupdate

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-cron-DevIT-autoupdate)

add cron job for DevIT automatic updates

**Options**: `MODE`

This function adds a cronjob for DevIT automatic updates
that can be downloaded from apt or git.

## v-add-cron-job

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-cron-job)
...
```bash
v-add-cron-job admin * * * * * sudo /usr/local/DevIT/bin/v-backup-users
```
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-cron-letsencrypt-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-cron-reports)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-cron-restart-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-database-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-database-temp-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-dns-on-web-alias)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-fastcgi-cache)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-firewall-ban)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-firewall-chain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-firewall-ipset)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-firewall-rule)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-fs-archive)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-fs-directory)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-fs-file)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-letsencrypt-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-letsencrypt-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-letsencrypt-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-account)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-account-alias)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-account-autoreply)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-account-forward)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-account-fwd-only)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-antispam)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-antivirus)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-catchall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-dkim)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-reject)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-smtp-relay)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-mail-domain-webmail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-remote-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-remote-dns-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-remote-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-api-ip)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-cgroups)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-dependencies)

**Options**:

Add php dependencies to DevIT
options: [MODE]

## v-add-sys-filemanager

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-filemanager)

add file manager functionality to DevIT Control Panel
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-firewall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-ip)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-pma-sso)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-quota)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-roundcube)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-sftp-jail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-smtp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-smtp-relay)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-snappymail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-ssh-jail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-sys-web-terminal)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-2fa)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-composer)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-notification)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-package)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-sftp-jail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-sftp-key)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-ssh-key)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-user-wp-cli)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-alias)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-allow-users)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-backend)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-ftp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-httpauth)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-proxy)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-redirect)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-ssl-force)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-ssl-hsts)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-ssl-preset)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-domain-stats-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-add-web-php)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-backup-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-backup-user-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-backup-user-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-backup-users)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-backup-users-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-cron-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-database-host-password)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-database-owner)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-database-password)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-database-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-domain-dnssec)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-domain-exp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-domain-ip)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-domain-soa)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-domain-tpl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-domain-ttl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-dns-record-id)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-domain-owner)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-firewall-rule)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-fs-file-permission)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-mail-account-password)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-mail-account-quota)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-mail-account-rate-limit)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-mail-domain-catchall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-mail-domain-rate-limit)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-mail-domain-sslcert)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-remote-dns-domain-exp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-remote-dns-domain-soa)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-remote-dns-domain-ttl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-api)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-config-value)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-db-alias)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-demo-mode)
...
## v-change-sys-DevIT-ssl

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-DevIT-ssl)

change DevIT ssl certificate
...
```bash
v-change-sys-DevIT-ssl /home/new/dir/path yes
```

This function changes DevIT SSL certificate and the key.

## v-change-sys-hostname

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-hostname)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-ip-name)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-ip-nat)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-ip-owner)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-ip-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-language)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-php)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-port)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-release)
...
DevIT Control Panel. This allows the user to switch between
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-service-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-timezone)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-web-terminal-port)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-sys-webmail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-config-value)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-contact)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-language)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-name)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-ns)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-package)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-password)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-php-cli)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-rkey)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-role)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-shell)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-sort-order)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-template)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-user-theme)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-backend-tpl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-dirlist)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-docroot)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-ftp-password)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-ftp-path)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-httpauth)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-ip)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-name)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-proxy-tpl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-sslcert)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-sslhome)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-change-web-domain-tpl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-check-access-key)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-check-api-key)
...
This function checks a key file in $DevIT/data/keys/

## v-check-fs-permission

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-check-fs-permission)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-check-mail-account-hash)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-check-user-2fa)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-check-user-hash)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-check-user-password)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-copy-fs-directory)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-copy-fs-file)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-copy-user-package)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-access-key)
...
This function removes a key from in $DevIT/data/access-keys/

## v-delete-backup-host

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-backup-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-backup-host-restic)
...
## v-delete-cron-DevIT-autoupdate

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-cron-DevIT-autoupdate)

delete DevIT autoupdate cron job

**Options**: –

This function deletes DevIT autoupdate cron job.

## v-delete-cron-job

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-cron-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-cron-reports)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-cron-restart-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-database-host)
...
This function for deleting the database host from DevIT configuration. It will
be deleted if there are no databases created on it only.

## v-delete-database-temp-user

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-database-temp-user)
...
```bash
v-delete-database-temp-user wordpress DevIT_sso_user mysql
```
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-databases)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-dns-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-dns-domains-src)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-dns-on-web-alias)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-fastcgi-cache)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-firewall-ban)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-firewall-chain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-firewall-ipset)
...
This function removes ipset from system and from DevIT

## v-delete-firewall-rule

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-firewall-rule)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-fs-directory)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-fs-file)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-letsencrypt-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-account)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-account-alias)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-account-autoreply)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-account-forward)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-account-fwd-only)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-antispam)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-antivirus)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-catchall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-dkim)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-reject)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-smtp-relay)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domain-webmail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-mail-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-remote-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-remote-dns-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-remote-dns-host)
...
This function for deleting the remote dns host from DevIT configuration.

## v-delete-remote-dns-record

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-remote-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-api-ip)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-cgroups)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-filemanager)

remove file manager functionality from DevIT Control Panel
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-firewall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-ip)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-mail-queue)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-pma-sso)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-quota)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-sftp-jail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-smtp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-smtp-relay)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-snappymail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-ssh-jail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-sys-web-terminal)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-2fa)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-auth-log)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-backup)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-backup-exclusions)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-ips)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-log)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-notification)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-package)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-sftp-jail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-ssh-key)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-user-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-alias)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-allow-users)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-backend)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-ftp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-httpauth)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-proxy)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-redirect)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-ssl-force)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-ssl-hsts)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domain-stats-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-delete-web-php)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-download-backup)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-dump-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-dump-site)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-export-rrd)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-extract-fs-archive)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-generate-api-key)

generate api key

**Options**: –

This function creates a key file in $DevIT/data/keys/

## v-generate-password-hash

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-generate-password-hash)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-generate-ssl-cert)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-dns-domain-value)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-fs-file-type)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-mail-account-value)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-mail-domain-value)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-sys-timezone)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-sys-timezones)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-user-salt)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-get-user-value)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-import-cpanel)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-import-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-import-directadmin)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-insert-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-insert-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-insert-dns-records)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-access-key)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-access-keys)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-api)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-apis)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-backup-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-backup-host-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-cron-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-cron-jobs)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-database-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-database-hosts)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-database-types)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-databases)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-default-php)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-dns-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-dns-records)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-dns-template)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-dns-templates)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-dnssec-public-key)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-firewall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-firewall-ban)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-firewall-ipset)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-firewall-rule)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-fs-directory)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-letsencrypt-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-account)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-account-autoreply)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-accounts)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-domain-dkim)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-domain-dkim-dns)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-mail-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-remote-dns-hosts)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-clamd-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-cpu-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-db-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-disk-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-dns-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-dovecot-config)
...
## v-list-sys-DevIT-autoupdate

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-DevIT-autoupdate)

list DevIT autoupdate settings

**Options**: `[FORMAT]`

This function for obtaining autoupdate settings.

## v-list-sys-DevIT-ssl

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-DevIT-ssl)

list DevIT ssl certificate

**Options**: `[FORMAT]`

This function of obtaining DevIT ssl files.

## v-list-sys-DevIT-updates

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-DevIT-updates)

list system updates

**Options**: `[FORMAT]`

This function checks available updates for DevIT packages.

## v-list-sys-info

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-info)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-interfaces)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-ip)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-ips)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-languages)
...
This function for obtaining the available languages for DevITCP
Output is always in the ISO language code

## v-list-sys-mail-status

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-mail-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-memory-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-mysql-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-network-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-nginx-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-pgsql-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-php)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-php-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-proftpd-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-rrd)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-services)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-shells)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-spamd-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-sshd-port)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-themes)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-users)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-vsftpd-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-web-status)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-sys-webmail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-auth-log)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-backup)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-backup-exclusions)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-backup-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-backups)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-backups-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-files-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-ips)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-log)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-notifications)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-ns)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-package)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-packages)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-ssh-key)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-user-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-users)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-users-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-domain-accesslog)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-domain-errorlog)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-templates)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-templates-backend)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-list-web-templates-proxy)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-log-action)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-log-user-login)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-log-user-logout)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-move-fs-directory)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-move-fs-file)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-open-fs-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-open-fs-file)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-purge-nginx-cache)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-quick-install-app)
...
```php
v-quick-install-app install admin domain.com WordPress email="info@DevITcp" password="123456" username="admin" site_name="DevITCP Demo" install_directory="/" language="nl_NL" php_version="8.2" database_create="true"
 example: v-quick-install-app app
 example: v-quick-install-app options admin domain.com WordPress
```

- The v-quick-install-app install command is used to automate the installation of web applications on a server managed by DevIT Control Panel.
- The v-quick-install-app app command is used to retrieve a list of web applications that can be quickly installed through the v-quick-install-app install command in the DevIT Control Panel. This command provides a convenient overview of supported applications and their versions, allowing users to choose which application they would like to deploy on their server. The names of the applications are case sensitive.
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-all)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-cron-jobs)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-databases)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-dns-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-mail-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-mail-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-users)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-web-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rebuild-web-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-refresh-sys-theme)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-rename-user-package)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-repair-sys-config)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-cron)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-dns)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-ftp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-mail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-proxy)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-service)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-system)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-web)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restart-web-backend)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-cron-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-cron-job-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-database-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-dns-domain-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-file-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-mail-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-mail-domain-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-user-full-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-user-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-web-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-restore-web-domain-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-revoke-api-key)
...
This function removes a key from in $DevIT/data/keys/

## v-run-cli-cmd

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-run-cli-cmd)
...
This function runs a limited list of cli commands with dropped privileges as the specific DevIT user

## v-schedule-letsencrypt-domain

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-schedule-letsencrypt-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-schedule-user-backup)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-schedule-user-backup-download)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-schedule-user-backup-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-schedule-user-restore)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-schedule-user-restore-restic)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-search-command)
...
This function searches for available DevIT Control Panel commands
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-search-domain-owner)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-search-fs-object)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-search-object)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-search-user-object)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-start-service)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-stop-firewall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-stop-service)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-cron-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-cron-jobs)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-database-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-databases)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-dns-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-firewall-rule)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-mail-account)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-mail-accounts)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-mail-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-mail-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-remote-dns-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-web-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-suspend-web-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-sync-dns-cluster)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-cron-job)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-cron-jobs)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-database)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-database-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-databases)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-dns-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-dns-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-dns-record)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-firewall-rule)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-mail-account)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-mail-accounts)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-mail-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-mail-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-remote-dns-host)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-user)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-web-domain)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-unsuspend-web-domains)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-database-disk)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-databases-disk)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-dns-templates)

update dns templates

**Options**: `[RESTART]`

This function for obtaining updated dns templates from DevIT package.

## v-update-firewall

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-firewall)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-firewall-ipset)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-host-certificate)

update host certificate for DevIT
...
This function updates the SSL certificate used for DevIT Control Panel.

## v-update-letsencrypt-ssl

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-letsencrypt-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-mail-domain-disk)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-mail-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-mail-domains-disk)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-mail-templates)

update mail templates

**Options**: `[RESTART]` `[SKIP]`

This function for obtaining updated webmail templates from DevIT package.

## v-update-sys-defaults

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-defaults)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-DevIT)

update DevIT package/configs
...
```bash
v-update-sys-DevIT DevIT-php
```

This function runs as apt update trigger. It pulls shell script from DevIT
server and runs it. (DevIT, DevIT-nginx and DevIT-php are valid options)

## v-update-sys-DevIT-all

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-DevIT-all)

update all DevIT packages

**Options**: –

This function of updating all DevIT packages

## v-update-sys-DevIT-git

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-DevIT-git)
...
```bash
v-update-sys-DevIT-git DevITcp staging/beta install
# Will download from the DevITcp repository
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-ip)
...
This function scans configured IP in the system and register them with DevIT
internal database. This call is intended for use on vps servers, where IP is
set by hypervisor.

## v-update-sys-ip-counters

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-ip-counters)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-queue)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-apache2)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-ftp)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-httpd)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-la)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-mail)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-mem)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-mysql)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-net)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-nginx)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-pgsql)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-sys-rrd-ssh)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-user-backup-exclusions)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-user-cgroup)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-user-counters)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-user-disk)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-user-package)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-user-quota)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-user-stats)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-domain-disk)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-domain-ssl)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-domain-stat)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-domain-traff)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-domains-disk)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-domains-stat)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-domains-traff)
...
[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-web-templates)

update web templates

**Options**: `[RESTART]` `[SKIP]`

This function for obtaining updated web (Nginx/Apache2/PHP) templates from the DevIT package.

## v-update-white-label-logo

[Source](https://github.com/DevITcp/DevITcp/blob/release/bin/v-update-white-label-logo)

update white label logo's

**Options**: `[DOWNLOAD]`

Replace DevIT logos with User created logo's
