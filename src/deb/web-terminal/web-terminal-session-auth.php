...
function deny(string $error): never {
	echo json_encode(['ok' => false, 'error' => $error], JSON_UNESCAPED_SLASHES), PHP_EOL;
	exit(0);
}
...
echo json_encode(['ok' => true, 'user' => $user, 'look' => $look], JSON_UNESCAPED_SLASHES), PHP_EOL;
