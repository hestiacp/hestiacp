...
ID='14' RECORD='@' TYPE='MX' VALUE='10 ASPMX4.GOOGLEMAIL.COM.' SUSPEND='no' DATE='%date%'
ID='15' RECORD='@' TYPE='MX' VALUE='10 ASPMX5.GOOGLEMAIL.COM.' SUSPEND='no' DATE='%date%'
ID='16' RECORD='@' TYPE='TXT' VALUE='"v=spf1 a mx ip4:%ip% ?all"' SUSPEND='no' DATE='%date%'
