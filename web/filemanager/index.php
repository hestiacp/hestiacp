 ...
 * Reworked to fit for Hestia Control Panel
                ...
                <ul class="navbar-nav mr-auto float-right">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink-5">
                            ...
                            <a title="<?php echo lng('Back to Hestia') ?>" class="dropdown-item nav-link" href="../"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lng('Back to Hestia') ?></a>
                            <a title="<?php echo lng('Logout') ?>" class="dropdown-item nav-link" href="../logout"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lng('Logout') ?></a>
                        </div>
                    </li>
                    <?php endif; ?>
                </ul>
