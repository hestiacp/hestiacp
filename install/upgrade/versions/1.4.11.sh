...
# DevIT Control Panel upgrade script for target version 1.4.11
...
if [ "$FIREWALL_SYSTEM" = "iptables" ]; then
	...
	rm -f /usr/lib/networkd-dispatcher/routable.d/10-DevIT-iptables /etc/network/if-pre-up.d/DevIT-iptables
