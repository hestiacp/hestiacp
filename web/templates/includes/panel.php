    ...
    <div class="top-bar">
        <div class="container top-bar-inner">
            ...
            <div class="top-bar-left">
                ...
                <!-- Logo / Home Button -->
                <?php $app_name = htmlentities($_SESSION["APP_NAME"]); ?>
                ...
                <div class="top-bar-usage">
                    ...
                    <div class="top-bar-usage-inner">
                        <span class="top-bar-usage-item">
                            <?php $user_display = htmlspecialchars($panel[$user]["NAME"]); ?>
                            <i class="fas <?= $user_icon ?>" title="<?= _("Logged in as") ?>: <?= $user_display ?>"></i>
                        ...
                        <span class="top-bar-usage-item">
                            <?php
                            $disk_size = humanize_usage_size($panel[$user]["U_DISK"]);
                            $disk_measure = humanize_usage_measure($panel[$user]["U_DISK"]);
                            ?>
                            <i class="fas fa-hard-drive" title="<?= _("Disk") ?>: <?= $disk_size ?> <?= $disk_measure ?>"></i>
                            <span class="u-text-bold">
                        ...
                        <span class="top-bar-usage-item">
                            <?php
                            $bw_size = humanize_usage_size($panel[$user]["U_BANDWIDTH"]);
                            $bw_measure = humanize_usage_measure($panel[$user]["U_BANDWIDTH"]);
                            ?>
                            <i class="fas fa-right-left" title="<?= _("Bandwidth") ?>: <?= $bw_size ?> <?= $bw_measure ?>"></i>
                            <span class="u-text-bold">
                                            ...
                                            <div class="top-bar-notification-inner">
                                                ...
                                                <p class="top-bar-notification-timestamp">
                                                    <time
                                                        ...
                                                        x-text="`${notification.TIMESTAMP_TEXT}`"></time>
                                                </p>
                                            </div>
                                        </li>
                                    </template>
