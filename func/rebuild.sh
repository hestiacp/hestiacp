...
#===========================================================================#
#                                                                           #
# DevIT Control Panel - Rebuild Function Library                           #
#                                                                           #
#===========================================================================#
...
rebuild_user_conf() {
	...
	if [ -x "$DevIT/data/packages/$PACKAGE.sh" ]; then
		$DevIT/data/packages/$PACKAGE.sh "$user" "$CONTACT" "$NAME"
	fi
	...
	# Add membership to DevIT-users group to non-admin users
...
rebuild_web_domain_conf() {
	...
	# domain folder permissions: DOMAINDIR_WRITABLE: default-val:no source:DevIT.conf
	DOMAINDIR_MODE=551
